...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='TestRun',
        ...
        self.parser.add_argument('--use_sem_map', action='store_true', help='Add semantic maps as inputs')
        self.parser.add_argument('--n_semantic_labels', type=int, default=80, help='no. of semantic labels')
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='global_with_local', help='selects model to use for netG')
        ...
        self.parser.add_argument('--niter_fix_global', type=int, default=0,
                                 help='number of epochs for which we only train the outermost local enhancer')

        # for instance-wise features
        self.parser.add_argument('--use_inst_map', action='store_true', help='if specified, add instance map as input')
        self.parser.add_argument('--use_rgb', action='store_true',
                                 help='if specified, add RGB as input')
